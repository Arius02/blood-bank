const DonationValidation = (user) => {
  ...
  const schema = Joi.object({
    ...
    blood_type: Joi.string()
      ...
      .required()
      .messages({
        "string.empty": "برجاء تحديد درجة خطورة الحالة"
      }),
    blood_bags_req: Joi.number()
      .max(10)
      .required()
      .messages(
        {
          "number.empty": "برجاء كتابة عدد الأكياس المطلوبة",
          "number.max": "عذراً لا يمكن طلب أكثر من عشر أكياس دم",
          "number.pattern.base": "برجاء كتابة عدد الأكياس المطلوبة بالأرقام"
        }
      ),
